...
const QuestionCard = (props) => {
  ...
  return (
    <div
      className={`w-4/5 min-h-[100px] m-3 p-2 bg-sky-50 hover:bg-azure-100 
    ...
    >
      <p className='m-3 text-lg font-bold'>{props.statement}</p>
